...
from amberelectric.api.renewables_api import RenewablesApi


class TestRenewablesApi(unittest.TestCase):
    """RenewablesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RenewablesApi()
