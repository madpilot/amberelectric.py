...
class TestGetAmber200ResponseInner(unittest.TestCase):
    """GetAmber200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmber200ResponseInner:
        """Test GetAmber200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmber200ResponseInner`
        """
        model = GetAmber200ResponseInner()
        if include_optional:
            return GetAmber200ResponseInner(
                duration = 5,
                spot_per_kwh = 6.12,
                per_kwh = 24.33,
    ...
    def testGetAmber200ResponseInner(self):
        """Test GetAmber200ResponseInner"""
