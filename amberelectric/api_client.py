...
from amberelectric import rest
from amberelectric.configuration import Configuration
from amberelectric.exceptions import ApiTypeError, ApiValueError, ApiException
from amberelectric.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.sites_get  # this is an instance of the class Endpoint
        api_instance.sites_get()  # this invokes api_instance.sites_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.sites_get.callable or self.callable in this class
