...
class Configuration:
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = "https://api.amber.com.au/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("amberelectric")
    ...
    def to_debug_report(self):
        ...
        return (
            ...
            "SDK Package Version: 2.0.3".format(env=sys.platform, pyversion=sys.version)
        )
