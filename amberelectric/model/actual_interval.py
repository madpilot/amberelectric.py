...
def lazy_import():
    ...
    globals()['ActualIntervalAllOf'] = ActualIntervalAllOf
    globals()['Interval'] = Interval
    globals()['TariffInformation'] = TariffInformation


class ActualInterval(ModelComposed):
    ...
    def __init__(self, duration, spot_per_kwh, per_kwh, date, nem_time, start_time, end_time, renewables, channel_type, spike_status, *args, **kwargs):  # noqa: E501
        """ActualInterval - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): defaults to "ActualInterval", must be one of ["ActualInterval", ]  # noqa: E501
        ...
        type = kwargs.get('type', "ActualInterval")
