...
def lazy_import():
    ...
    globals()['CurrentIntervalAllOf'] = CurrentIntervalAllOf
    globals()['Interval'] = Interval
    globals()['Range'] = Range
    globals()['TariffInformation'] = TariffInformation


class CurrentInterval(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, duration, spot_per_kwh, per_kwh, date, nem_time, start_time, end_time, renewables, channel_type, spike_status, estimate, *args, **kwargs):  # noqa: E501
        """CurrentInterval - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): defaults to "CurrentInterval", must be one of ["CurrentInterval", ]  # noqa: E501
        ...
        type = kwargs.get('type', "CurrentInterval")
