...
def lazy_import():
    ...
    globals()['ForecastIntervalAllOf'] = ForecastIntervalAllOf
    globals()['Interval'] = Interval
    globals()['Range'] = Range
    globals()['TariffInformation'] = TariffInformation


class ForecastInterval(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, duration, spot_per_kwh, per_kwh, date, nem_time, start_time, end_time, renewables, channel_type, spike_status, *args, **kwargs):  # noqa: E501
        """ForecastInterval - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): defaults to "ForecastInterval", must be one of ["ForecastInterval", ]  # noqa: E501
        ...
        type = kwargs.get('type', "ForecastInterval")
