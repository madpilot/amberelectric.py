...
class ForecastInterval(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["duration", "spotPerKwh", "perKwh", "date", "nemTime", "startTime", "endTime", "renewables", "channelType", "tariffInformation", "spikeStatus", "descriptor", "type", "range", "advancedPrice"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ForecastInterval']):
