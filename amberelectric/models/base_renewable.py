...
class BaseRenewable(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseRenewable:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseRenewable:
        """Create an instance of BaseRenewable from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseRenewable.parse_obj(obj)

        _obj = BaseRenewable.parse_obj(
            {
                "type": obj.get("type"),
