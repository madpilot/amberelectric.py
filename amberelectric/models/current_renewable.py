...
class CurrentRenewable(BaseModel):
    """
    CurrentRenewable
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrentRenewable:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrentRenewable:
        """Create an instance of CurrentRenewable from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurrentRenewable.parse_obj(obj)

        _obj = CurrentRenewable.parse_obj(
            {
                "type": obj.get("type"),
