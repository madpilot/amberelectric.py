...
class CurrentInterval(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["duration", "spotPerKwh", "perKwh", "date", "nemTime", "startTime", "endTime", "renewables", "channelType", "tariffInformation", "spikeStatus", "descriptor", "type", "range", "estimate"]
