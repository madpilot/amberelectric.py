...
class Channel(BaseModel):
    ...
    """ # noqa: E501
    identifier: StrictStr = Field(description="Identifier of the channel")
    type: ChannelType
    tariff: StrictStr = Field(description="The tariff code of the channel")
    __properties: ClassVar[List[str]] = ["identifier", "type", "tariff"]
