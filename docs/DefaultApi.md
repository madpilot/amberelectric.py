...
------------- | ------------- | -------------
[**get_current_prices**](DefaultApi.md#get_current_prices) | **GET** /sites/{siteId}/prices/current | 
[**get_current_renewables**](DefaultApi.md#get_current_renewables) | **GET** /state/{state}/renewables/current | 
[**get_prices**](DefaultApi.md#get_prices) | **GET** /sites/{siteId}/prices | 
[**get_sites**](DefaultApi.md#get_sites) | **GET** /sites | 
[**get_usage**](DefaultApi.md#get_usage) | **GET** /sites/{siteId}/usage | 
...
async with amberelectric.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->get_current_renewables:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_current_renewables: %s\n" % e)
```
...
async with amberelectric.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->get_sites:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_sites: %s\n" % e)
```
...
async with amberelectric.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->get_usage:\n")
        pprint(api_response)
    except Exception as e:
